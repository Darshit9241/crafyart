...
import NewSubCategoryTest from "@/src/components/AsyncComponent/newCategoryTest/NewSubCategoryPage";
...
export default async function page({ params, searchParams }: PropsType) {
  ...
  const categoryData: any = await getData(slug, slug2, searchParams);
